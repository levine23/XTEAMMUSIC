...
BOT_TOKEN = getenv("BOT_TOKEN", "8182850821:AAGbKSVfccUdpELu0Ck0YuXs43pRTD5aqME")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/xteam-cloner/XTEAMMUSIC",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/xteam-cloner/XTEAMMUSIC")
